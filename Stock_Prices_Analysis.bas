   ...
   'Loop through all tickers
        For i = 2 To lastRow
            ...
            If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
                ...
                'Assign values for total stock volume
                 total_volume = total_volume + ws.Cells(i, 7).Value
                 
                 'Conditional for nonzero values
                ...
                'Computing yearly change and percent change variables
                ...
                'Populate values in summary table
